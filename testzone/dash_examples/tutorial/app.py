...
#----------------------------------------------------------------
# app layout
# the html items can be styled by a sepearate css file
# this will likley be best, messy to include in this file
app.layout = html.Div([
...
# compoment that has the necessary id's, these are then used
# by the the update_graph function
@callback(
